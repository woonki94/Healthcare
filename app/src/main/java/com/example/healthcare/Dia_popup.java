...
public class Dia_popup extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        y = ((Dia_Act) Dia_Act.context).year;
        m = ((Dia_Act) Dia_Act.context).month;
        d = ((Dia_Act) Dia_Act.context).day;
